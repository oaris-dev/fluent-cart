...
const InspectorSettings = ({ attributes, setAttributes, selectedProduct, setSelectedProduct, isInsideProductInfo, isLink, linkTarget }) => {
                                        ...
                                        {selectedProduct?.post_title && (
                                            <div className="fct-selected-products">
                                                ...
                                                <div className="fct-selected-products__preview">
                                                    <strong>{blocktranslate('Title')}:</strong> {selectedProduct.post_title}
                                                </div>
                                            </div>
                                        )}
